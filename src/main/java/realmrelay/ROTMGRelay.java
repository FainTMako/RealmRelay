...
public final class ROTMGRelay {
	...
	public static void main(String[] args) {
		...
		if (ROTMGRelay.instance.listenSocket.start()) {
			ROTMGRelay.echo("Realm-Relay for 27.7.3 is brought to you by Gratin.");
			ROTMGRelay.echo("Any donations would be extremely appreciated!");
			ROTMGRelay.echo("BTC: 18st8gMvHUMTpQvBbrX5koL7nF2Cc1FhtC");
			ROTMGRelay.echo("Paypal: gratinmpb@gmail.com OR copy paste : https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=5KRKE6B5GS29Y&lc=US&item_name=Realm%2dRelay%20Maintenance&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted");
			ROTMGRelay.echo("Check the github repo for updates (just download as zip and extract): https://github.com/AMPBEdu/Realm-Relay ");
			ROTMGRelay.echo("OR use git to clone and pull updates easily with git : https://github.com/AMPBEdu/Realm-Relay.git");
